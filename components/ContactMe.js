  ...
  return (
    <section id="contact" className="bg-gradient-to-b from-gray-900 to-black min-h-screen flex flex-col items-center justify-center py-16">
      ...
      <div className="flex flex-wrap justify-center gap-8 max-w-4xl px-4">
        ...
        <a
          href="https://www.facebook.com/your-facebook/" // Replace with your Facebook URL
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="mailto:your-email@gmail.com" // Replace with your Gmail address
        ...
        <a
          href="https://twitter.com/your-x-handle" // Replace with your X (Twitter) URL
          target="_blank"
          rel="noopener noreferrer"
