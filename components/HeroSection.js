        ...
        <Hero3D>
          ...
          >
            ...
            >
              ...
              <a
                href="#contact"
                className="px-8 py-3 rounded-full bg-gray-800/80 backdrop-blur-sm text-white font-semibold shadow-lg hover:bg-gray-700 transition-all transform hover:scale-105"
              >
                Contact Me
              </a>
            </motion.div>
            ...
            >
              <div className="bg-gray-800/80 backdrop-blur-sm rounded-lg p-6 shadow-lg">
